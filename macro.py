...
location_targets = {
    ...
    'game':  # 按照官方手册填入
        {
            # 23赛季相机位姿估计标记点
            # 'red_base': [1.760, 7.539, 0.200 + 0.920],
            # 'blue_outpost': [16.776, 12.565, 1.760],
            # 'red_outpost': [11.176, 2.435, 1.760],
            # 'blue_base': [26.162, 7.539, 0.200 + 0.920],
            # 'r_rt': [8.805, -5.728 - 0.660 + 15., 0.120 + 0.495],
            # 'r_lt': [8.805, -5.728 + 15., 0.120 + 0.495],
            # 'b_rt': [19.200, -9.272 + 0.660 + 15., 0.120 + 0.495],
            # 'b_lt': [19.200, -9.272 + 15., 0.120 + 0.495]
