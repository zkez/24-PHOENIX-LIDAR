...
class Predictor:
    ...
    def cated_infer(self, frame):
        ...
        cated_frame = [first_frame, second_frame, third_frame, forth_frame]
    ...
    def com_post_process(self, pred, img_tensor, im0, frame_height, frame_width):
        total_locations = []
        # 我们要首先保证pred是有长度的
        location_1, show_im_1 = self.post_processing([pred[0]], img_tensor[0][None], im0[0])
    ...
    def com_shift(self, first_frame, second_frame, third_frame, forth_frame):
        ...
        return torch.cat([first_frame, second_frame, third_frame, forth_frame])
